  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between px-4 py-8">
      ...
      <div className="w-full text-center md:text-left md:w-1/2 md:ml-16">
        <h3 className="text-[#252B42] hover:text-pink-500 hover:text-4xl font-bold text-[16px] mb-6">CONTACT US</h3>
        <h1 className="text-[#252B42] hover:text-pink-500 font-bold text-[32px] sm:text-[48px] md:text-[58px] mb-6">
          Get in touch <br />
          today!
        </h1>
        <p className="text-[#737373] hover:text-pink-500  hover:text-2xl text-[16px] sm:text-[18px] md:text-[20px] mt-5">
          We know how large objects will act, <br />
          but things on a small scale
        </p>

        {/* Phone and Fax Section */}
        <div className="text-[#252B42] hover:text-pink-500 font-bold text-[24px] mt-8">
