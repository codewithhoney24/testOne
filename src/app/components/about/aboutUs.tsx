  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between px-4 py-8">
      ...
      <div className="w-full text-center md:text-left md:w-1/2 md:ml-16">
        ...
        <p className="text-[#737373]  hover:text-yellow-400 text-[16px] sm:text-[18px] md:text-[20px] mt-5">
        ...
        <div className="mt-7 flex justify-center md:justify-start">
          <button className="hover:text-3xl px-4 py-3 bg-[#23A6F0] text-[#FAFAFA] rounded-md hover:bg-blue-500 transition-all text-center text-[16px]">
            Get Quote Now
          </button>
        </div>
      </div>
